...
(0, _jquery2.default)(function () {
    var movies = (0, _jquery2.default)('.movies');
    var moviesData = 'https://movie-ranking.herokuapp.com/movies';
    var aZ = (0, _jquery2.default)('#ascending');
    var zA = (0, _jquery2.default)('#descending');
    ...
    function loadMovies(data) {
        console.log();
        (0, _jquery2.default)(data).each(function () {
            var li = (0, _jquery2.default)('<li>');
            var h3 = (0, _jquery2.default)('<h3>').text(this.title);
            var img = (0, _jquery2.default)('<img>').attr('src', this.poster);
            var stars = (0, _jquery2.default)('<div class="rating"></div>');
            var ratingBox = (0, _jquery2.default)('<div class="rating-box"></div>');
            stars.attr('data-stars', '0');
            ratingBox.append(stars);

            var _loop = function _loop(i) {
                var star = (0, _jquery2.default)('<span data-rating=' + i + '>\u2606</span>').hide();
                stars.append(star);
                (0, _jquery2.default)(img).click(function () {
                    (0, _jquery2.default)(this).parent().siblings().toggle();
                    (0, _jquery2.default)(this).toggleClass('poster-active');
                    (0, _jquery2.default)('.container').css('height', '100vh');
                    star.toggle();
                    (0, _jquery2.default)(this).parent().find('p').toggle();
                    intro.toggle();
                    console.log((0, _jquery2.default)(this).next().data('count'));
                });
                (0, _jquery2.default)(star).bind('click', function (e) {
                    adRating(this, id, ratingData);
                    (0, _jquery2.default)(this).parent().children().unbind('click');
                    var thanksPage = (0, _jquery2.default)('<div class="thank-you-page"></div>');
                    var p = (0, _jquery2.default)('<p>').text('Thank you for your vote!');;
                    thanksPage.append(p).show();
                    (0, _jquery2.default)('body').append(thanksPage);
                });
            };
            ...
            movies.append(li);
            var ratingData = 'https://movie-ranking.herokuapp.com/movies/' + this.id + '/ratings';
            var id = this.id;
            _jquery2.default.ajax({
                url: ratingData
            }).done(function (data) {
    ...
    function adRating(star, id, url) {
        (0, _jquery2.default)(star).parent().attr('data-stars', (0, _jquery2.default)(star).data('rating'));
        _jquery2.default.ajax({
            url: url,
            data: JSON.stringify({ movie_id: id, rating: (0, _jquery2.default)(star).data('rating') }),
            method: "POST",
            contentType: "application/json",
            cacheControl: "no-cache"
        });
    ...
    function loadRating(movie, ratingBox, id) {
        ...
        if (id == movieId) {
            var p = (0, _jquery2.default)('<p>').text(rating + '/5').hide();
            ratingBox.append(p);
        }
    };
    sort();
...
var objectPath = __webpack_require__(5);
var sortBy;
var sort;
var type;
