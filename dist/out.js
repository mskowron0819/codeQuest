...
var sortBy = __webpack_require__(5);
$(function () {
    var repertuar = $('.repertuar');
    ...
    function loadMovies(data) {
        ...
        $(data).each(function () {
            ...
            var img = $('<img>').attr('src', this.poster);

            var stars = $('<div>').attr('class', 'rating');
            stars.attr('data-stars', '0');

            var _loop = function _loop(i) {
                var star = $('<span data-rating=' + i + '>\u2606</span>').hide();
                stars.append(star);
...
var objectPath = __webpack_require__(4);
var sortBy;
var sort;
var type;
